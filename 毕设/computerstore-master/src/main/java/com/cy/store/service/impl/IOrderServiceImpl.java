...
import com.cy.store.service.exception.OrderNotExistsException;
...
public class IOrderServiceImpl implements IOrderService {
     ...
     * @return com.cy.store..entity.Order
     **/
    @Override
     ...
     * @param oid 订单oid
     * @return java.util.List<com.cy.store.entity.OrderItem>
     **/
    @Override
     ...
     * Description : 根据订单oid查询订单的具体逻辑
     * @param oid 订单oid
     * @return java.util.List<com.cy.store.vo.OrderVo>
     **/
    @Override
